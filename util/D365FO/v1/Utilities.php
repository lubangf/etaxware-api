...
Class Utilities{
    ...
    function sendemailnotification($recipientname, $recipientemail, $subject, $body, $attachments, $apikey, $version){
        ...
        $response  =  "";
        $web = \Web::instance();
        $url = 'http://127.0.0.1/etaxware-api/sendmail';//api endpoint
        ...
        $response .=  '<ERPUSER></ERPUSER>';
        $response .=  '<WINDOWSUSER></WINDOWSUSER>';
            ...
            try {
                ...
                try {
                    ...
                    foreach ($taxes as $obj) {
                        ...
                        $obj['goodid'] = empty($t_goods[$j]['id'])? 'NULL' : $t_goods[$j]['id'];
