 ...
 * @date: 25-04-2026
 * @file: Utilities.php
 * @path: ./util/FTS/v12/Utilities.php
...
Class Utilities{
    ...
    function createcreditnote($creditnotedetails, $goods, $taxes, $buyer, $userid){
        ...
        try{
			...
			$mappedReasonCode = $this->mapreasoncode($creditnotedetails['reasoncode']);
			$creditnotedetails['reasoncode'] = (trim((string)$mappedReasonCode) != '') ? $mappedReasonCode : $creditnotedetails['reasoncode'];
