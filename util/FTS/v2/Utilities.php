 ...
 * @date: 22-01-2026
 * @file: Utilities.php
 * @path: ./util/Fts/v2/Utilities.php
	    ...
	    try {
	        ...
	        try{
	            ...
	            foreach ($goods as $obj) {
	                 ...
	                 */
	                $obj['excisetax'] =  $obj['exciseflag'] == '101'? $this->truncatenumber($obj['excisetax'], 3) : '';
	                ...
	                $t_goods[] = array(
	                    ...
	                    'exciseTax' => empty($obj['excisetax']) || $obj['exciseflag'] == '102'? '' : strval($obj['excisetax']),
	    ...
	    try {
	        ...
	        try{
	            ...
	            foreach ($goods as $obj) {
	                 ...
	                 * Description: Add 3 decimal places to excise tax
	                 */
	                // $obj['excisetax'] = $this->truncatenumber($obj['excisetax'], 3);
	                $obj['excisetax'] =  $obj['exciseflag'] == '101'? $this->truncatenumber($obj['excisetax'], 3) : '';
