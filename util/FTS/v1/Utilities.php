 ...
 * @date: 09-01-2026
 * @file: Utilities.php
 * @path: ./util/Fts/v1/Utilities.php
...
Class Utilities{
    ...
    function computeExciseDuty($userid, $product_code, $qty, $unit, $amount, $discount, $discountpct){
        ...
        foreach($temp as $obj){
            ...
            if ($obj->type == '101'){
                // 101-Percentage
                $tax101_amount = $unit * ((float)$obj->rate/100);
                ...
                $tax101[] = array(
                    ...
                    'exciseRule' => 1,
                    'exciseTax' => $unit * ((float)$obj->rate/100),
                    'pack' => $pdct->pack,
                    'stick' => $pdct->stick,
                    'exciseUnit' => $obj->unit,
	    ...
	    try {
	        ...
	        $products = array(
	            array(
	                ...
	                'packageScaledValue' => empty($product['packagescaledvalue'])? '' : round($product['packagescaledvalue'], 8),
	                'pieceScaledValue' => empty($product['piecescaledvalue'])? '' : round($product['piecescaledvalue'], 8),
	                'exciseDutyCode' => $product['exciseDutyCode'],
	        ...
	        try{
	            ...
	            foreach ($goods as $obj) {
	                ...
	                $t_goods[] = array(
	                    ...
	                    'taxRate' => strtoupper(trim($obj['taxcategory'])) == 'C: EXEMPT (-)'? '-' : (empty($obj['taxrate'])? '' : number_format($obj['taxrate'], 2, '.', '')),
	                    ...
	                    'exciseTax' => empty($obj['excisetax'])? '' : round($obj['excisetax'], 2),
	            ...
	            if ($this->vatRegistered == 'Y') {
	                ...
	                foreach ($taxes as $obj) {
	                    ...
	                    $t_taxes[] = array(
	                        ...
	                        'taxRate' => strtoupper(trim($obj['taxcategory'])) == 'C: EXEMPT (-)'? '-' : (empty($obj['taxrate'])? '0' : number_format($obj['taxrate'], 3, '.', '')),
	            ...
	            if ($this->vatRegistered == 'Y') {
	                ...
	                foreach ($taxes as $obj) {
	                    ...
	                    $t_taxes[] = array(
	                        ...
	                        'taxCategory' => empty($obj['taxcategory'])? '' : $obj['taxcategory'],
	                        'netAmount' => empty($obj['netamount'])? '0' : strval($obj['netamount']),
	                        'taxRate' => strtoupper(trim($obj['taxcategory'])) == 'C: EXEMPT (-)'? '-' : (empty($obj['taxrate'])? '0' : number_format($obj['taxrate'], 2, '.', '')),
	                        'taxAmount' => empty($obj['taxamount'])? '0' : strval($obj['taxamount']),
	                        'grossAmount' => empty($obj['grossamount'])? '0' : strval($obj['grossamount']),
	                        'exciseUnit' => empty($obj['exciseunit'])? '' : $obj['exciseunit'],
	                        'exciseCurrency' => empty($obj['excisecurrency'])? '' : $obj['excisecurrency'],
