...
Class Api{
    ...
    function index(){              
        ...
        $this->response .=  "<RETURNCODE>" . htmlspecialchars($this->code .' ---'. $this->appsettings['APPVERSION'] ) . "</RETURNCODE>";
    ...
    function uploadinvoice(){
     ...
     $importServicesSeller = array(           
				...
				"importAttachmentContent"=>"MIIDFjCCAf6gAwIBAgIRAKPGAol9CEdpkIoFa8huM6zfj1WEBRxteoo6PH46un4FGj4N6ioIGzVr9G40uhQGdm16ZU+q44XjW2oUnI9w="
				);					
