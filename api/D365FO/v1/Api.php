        ...
        if ($this->errorcode) {
            ...
            if ($this->userpermissions[$permission]) {
                ...
                $product = array(
                     ...
                     * Date: 2025-08-23
                     * Author: Francis Lubanga <francis.lubanga@gmail.com>
                     * Description: Add additional data points to the product object.
                     */
                ...
                if($inv_check->dry ()){
                    ...
                    if (isset($json['INVENTORIES'])) {
                        foreach ($json['INVENTORIES'] as $obj){
                            ...
                            /**
                             * Determine the tax code relevant to the product. Dynamics 365 F&O will always send a NULL TAXCODE
                             */
