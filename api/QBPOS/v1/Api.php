...
/**
 * @name Api.php
 * @desc This file is part of the etaxware-api app. This is the API version 1
 * @date: 08-11-2022
 * @file: Api.php
 * @path: ./api/QBPOS/v1/Api.php
        ...
        if ($this->errorcode) {
            ...
            if ($this->userpermissions[$permission]) {
                ...
                try {
                    ...
                    $erpcustomercode = trim($json['CUSTOMERCODE']);
                    ...
                    if(isset($n_data['records'])){
                        ...
                        if ($n_data['records']) {
                            ...
                            if ($pdct->dry()) {
                                ...
                                $product['description'] = "This product was created by the QBPOS api";
                                ...
                                $product['description'] = "This product was updated by the QBPOS api";
                ...
                if($inv_check->dry ()){
                    ...
                    if (isset($json['INVENTORIES'])) {
                        foreach ($json['INVENTORIES'] as $obj){
                            ...
                            /**
                             * Determine the tax code relevant to the product. QBPOS will always send a NULL TAXCODE
                             */
