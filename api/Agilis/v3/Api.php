                    ...
                    if(isset($n_data['records'])){
                        ...
                        if ($n_data['records']) {
                            ...
                            if ($pdct->dry()) {
                                ...
                                $product['description'] = "This product was created by the Agilis api";
                                ...
                                $product['description'] = "This product was updated by the Agilis api";
                ...
                if($inv_check->dry ()){
                    ...
                    if (isset($json['INVENTORIES'])) {
                        foreach ($json['INVENTORIES'] as $obj){
                            ...
                            /**
                             * Determine the tax code relevant to the product. Agilis will always send a NULL TAXCODE
                             */
