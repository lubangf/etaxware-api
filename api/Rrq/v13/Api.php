...
/**
 * @name Api.php
 * @desc This file is part of the etaxware-api app. This is the API version 10
 * @date: 27-06-2025
 * @file: Api.php
 * @path: ./api/Rrq/v11/Api.php
...
Class Api{
    ...
    function syncproducts(){
            ...
            if ($this->userpermissions[$permission]) {
                ...
                do {
                    ...
                    if(isset($data['records'])){
                        ...
                        $body = '<html><body>
                                            <p>Hello,</p></br>
                                            <p>Your request to sync products failed with the following details;</p>
                                            <p>Product: <b></b></p>
                                            <p>Error Code: <b>' . $this->code . '</b></p>
                                            <p>Error Message: <b>' . $this->message . '</b></p>
                                            </br>
        ...
        header ("transfer-coding: gzip");
        header ("content-encoding: gzip");
        //header ("content-type: application/json; charset=utf-8 transfer-coding: gzip content-encoding: gzip transfer-encoding: chunked");
 
        //print $this->response;
        die(gzencode(json_encode($this->response)));
        //die(base64_encode(json_encode($this->response)));
        return;
